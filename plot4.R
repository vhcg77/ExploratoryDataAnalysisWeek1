...
par(mfrow = c(2,2))
par(mar=c(4,4,2,2))
plot(Dates, partial_data$Global_active_power, type = "l", ylab = "Global Active Power", xlab = "")

plot(Dates, partial_data$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")
...
plot(Dates, partial_data$Global_reactive_power, type = "l", ylab = "Global Reactive Power", xlab = "datetime")
